...
<script type="text/javascript">
  window.Global = {
    ...
    API_BASE_URL: 'https://class.coursera.org/repdata-013/human_grading/api/',

    COURSE_BASE_URL: '//class.coursera.org/repdata-013/',
    SITES_ASSETS_BASE_URL: 'https://dw0ugk4msqulk.cloudfront.net/a813b0942ad5cdb4aaae4b195e3dd8a9f58f6438/',

    humanGradingLinkHref: "https:\/\/class.coursera.org\/repdata-013\/human_grading\/",
    humanGradingLinkText: "Peer Assessments",

    BACKBONE_BASE_URL: '//class.coursera.org/repdata-013/human_grading/view/',
    BACKBONE_ROOT: '/repdata-013/human_grading/view/',
...
<!--[if !IE]> --><script>document.getElementById("coursera-loading-js").style.display = 'block';</script><!-- <![endif]--><script>if (/zh/i.test(window.localStorage ? localStorage.getItem('locale') : '') || '{{ locale }}') {
  document.getElementById('get-browser-zh').style.display = 'block';
    ...
    <script src='https://dw0ugk4msqulk.cloudfront.net/a813b0942ad5cdb4aaae4b195e3dd8a9f58f6438/pages/hg/thirdparty/webshims/extras/modernizr-custom.js' ></script>
  <script src="https://dw0ugk4msqulk.cloudfront.net/a813b0942ad5cdb4aaae4b195e3dd8a9f58f6438/js/vendor/require.v2-1-1.js"></script><script data-baseurl="https://dw0ugk4msqulk.cloudfront.net/a813b0942ad5cdb4aaae4b195e3dd8a9f58f6438/" data-version="a813b0942ad5cdb4aaae4b195e3dd8a9f58f6438" data-timestamp='1429137210067' data-debug='0' data-locale="en_US" id="_require">if(document.getElementById('coursera-loading-js').style.display == 'block') {
  (function(el) {
     require.config({
       //enforceDefine: true,
       waitSeconds: 75,
      ...
      return JSON.parse("{\"id\":4521886,\"email_address\":\"gonzaloportillofontan@gmail.com\",\"full_name\":\"Gonzalo del Portillo Font\\u00e1n\",\"locale\":\"en_US\",\"timezone\":\"America\\\/Los_Angeles\",\"access_group_id\":\"4\",\"registration_time\":\"1427187223\",\"last_access_time\":\"1429514383\",\"last_access_ip\":\"88.87.132.116\",\"signature_track_register_time\":\"0\",\"email_announcement\":\"1\",\"email_forum\":\"1\",\"in_signature_track\":\"0\",\"wishes_proctored_exam\":\"0\",\"first_name\":\"Gonzalo\",\"permissions\":[\"default\",\"allow_site_access\"],\"group\":\"Student\",\"anonymous\":false,\"forum_title\":\"Student\",\"signature_track_state\":1,\"verified_quizzes\":[],\"submitted_quizzes\":[\"79\",\"81\"],\"scheduled_proctored_exam\":null,\"last_chance_modal\":1,\"flexjoin_last_chance_modal\":null}");
  });
define('pages/spark/models/course.json', [], function(){
      return JSON.parse("{\"id\":973514,\"isPrivate\":false,\"type\":\"public\",\"name\":\"Reproducible Research\",\"instructor\":\"Roger D. Peng, PhD, Jeff Leek, PhD, Brian Caffo, PhD\",\"sessionName\":\"repdata-013\",\"externalBaseURL\":\"https:\\\/\\\/www.coursera.org\\\/\",\"shortname\":\"repdata\",\"host\":\"https:\\\/\\\/www.coursera.org\\\/\",\"assetUnversionedLink\":\"https:\\\/\\\/dw0ugk4msqulk.cloudfront.net\\\/\",\"cheggID\":\"\",\"hasLTI\":true,\"badgevilleDomain\":\"\",\"linkable\":false,\"universityShortname\":\"jhu\",\"signatureTrackStatus\":{\"signature_track_enabled\":1},\"courseURLs\":{\"log_in_link\":\"https:\\\/\\\/www.coursera.org\\\/login?post_redirect=https%3A%2F%2Fwww.coursera.org%2Flogin%3Fuser_action%3Dclass%26course_id%3D973514%26post_redirect%3Dhttps%253A%252F%252Fclass.coursera.org%252Frepdata-013%252Fauth%252Fauth_redirector%253Ftype%253Dlogin%2526subtype%253Dnormal%2526visiting%253D\",\"sign_up_link\":\"https:\\\/\\\/www.coursera.org\\\/signup?enroll_cid=973514&enroll_sn=repdata&enroll_n=Reproducible Research\",\"view_course_info_link\":\"https:\\\/\\\/www.coursera.org\\\/course\\\/repdata\",\"sign_up_link_cant_enroll\":\"https:\\\/\\\/www.coursera.org\\\/signup?post_redirect=https%3A%2F%2Fwww.coursera.org%2Fcourse%2Frepdata\"},\"courseBase\":\"https:\\\/\\\/class.coursera.org\\\/repdata-013\\\/\",\"search\":true,\"hideWiki\":true,\"aceStartRegistrationDate\":\"Wed 31 Dec 1969  4:00 PM PST\",\"aceEndRegistrationDate\":\"Wed 31 Dec 1969  4:00 PM PST\",\"aceExamStartDate\":\"Wed 31 Dec 1969  4:00 PM PST\",\"aceExamEndDate\":\"Wed 31 Dec 1969  4:00 PM PST\",\"aceExamRules\":\"\",\"aceExamDuration\":\"\",\"aceBeforeExam\":false,\"aceAfterExam\":true,\"aceHours\":null,\"aceCreditType\":\"\",\"acePrice\":null,\"aceExamID\":null,\"aceEligible\":false,\"canRegisterForACE\":false,\"specialization\":{\"numCourse\":9,\"image\":\"https:\\\/\\\/s3.amazonaws.com\\\/coursera\\\/specializations\\\/jhudatascience\\\/logo_small.png\",\"id\":1,\"short_name\":\"jhudatascience\",\"name\":\"Data Science\"},\"supportForums\":true,\"textbooks\":\"\",\"inVideoQuizV2\":false,\"in_flexjoin\":0,\"honorCodeExtraText\":\"\",\"honorCodeCustomTitle\":\"\",\"honorCodeCustomButton\":\"\",\"studentAccessDisabled\":0,\"disableQQs\":false}");
  });
  define('pages/spark/models/navbar.json', [], function(){
      return JSON.parse("{\"items\":[{\"name\":\"Announcements\",\"icon\":\"home\",\"link_type\":\"circuit\",\"link_data\":\"class:index\"},{\"name\":\"Week-by-Week\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Week 1: Concepts\",\"icon\":\"\",\"link_type\":\"wiki\",\"link_data\":\"Week_1\"},{\"name\":\"Week 2: Tools\",\"icon\":\"\",\"link_type\":\"wiki\",\"link_data\":\"Week_2\"},{\"name\":\"Week 3: Distribution and Checklist\",\"icon\":\"\",\"link_type\":\"wiki\",\"link_data\":\"Week_3\"},{\"name\":\"Week 4: Case Studies\",\"icon\":\"\",\"link_type\":\"wiki\",\"link_data\":\"Week_4\"},{\"name\":\"Lectures\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Lecture Videos\",\"icon\":\"lecture\",\"link_type\":\"circuit\",\"link_data\":\"lecture:index\"},{\"name\":\"Lecture Slides (link to GitHub)\",\"icon\":\"\",\"link_type\":\"window_link\",\"link_data\":\"https:\\\/\\\/github.com\\\/rdpeng\\\/courses\\\/tree\\\/master\\\/05_ReproducibleResearch\"},{\"name\":\"Exercises\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Quizzes\",\"icon\":\"quiz\",\"link_type\":\"circuit\",\"link_data\":\"quiz:index\"},{\"name\":\"Peer Assessments 1 & 2\",\"icon\":\"assignment\",\"link_type\":\"circuit\",\"link_data\":\"human_grading:index\"},{\"name\":\"\",\"icon\":\"\",\"link_type\":\"circuit\",\"link_data\":\"\"},{\"name\":\"About the course\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Syllabus\",\"icon\":\"wiki\",\"link_type\":\"wiki\",\"link_data\":\"syllabus\"},{\"name\":\"About the Instructor\",\"icon\":\"\",\"link_type\":\"wiki\",\"link_data\":\"About_the_Instructor\"},{\"name\":\"Community\",\"icon\":\"\",\"link_type\":\"heading\",\"link_data\":\"\"},{\"name\":\"Discussion Forums\",\"icon\":\"forum\",\"link_type\":\"circuit\",\"link_data\":\"forum:index\"},{\"name\":\"DSS Community Site\",\"icon\":\"\",\"link_type\":\"window_link\",\"link_data\":\"http:\\\/\\\/datasciencespecialization.github.io\\\/\"}]}");
  });
